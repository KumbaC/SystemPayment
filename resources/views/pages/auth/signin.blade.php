                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                        <div>
                            <div class="mb-5 sm:mb-8">
                                <h1 class="text-title-sm sm:text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">Iniciar Sesión</h1>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Ingresa tu correo y contraseña para acceder al sistema.</p>
                            </div>
                            <div>
                            @if ($errors->any())
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="admin@negocio.com" required
                                    ...
                                    <div class="flex items-center justify-between">
                                        <label class="flex cursor-pointer items-center text-sm text-gray-700 dark:text-gray-400">
                                            <input type="checkbox" name="remember" value="1" class="mr-2 rounded" />
                                            Recordarme
                                        </label>
                                    </div>
                                    <div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Sistema de Gestión · Contabilidad USD · Facturación Bs
                        </p>
                    </div>
                </div>
            </div>
