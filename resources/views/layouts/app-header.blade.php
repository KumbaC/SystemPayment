    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="/images/logo/logo.png" height="100" width="100" alt="Logo" />
                <img class="hidden dark:block" src="/images/logo/logo-dark.png" height="100" width="100"  alt="Logo" />
            </a>
            ...
            <!-- Exchange Rate (desktop) -->
            @php($exchangeRateUsdVes = (float) \App\Models\Setting::get('exchange_rate_usd_ves', 1))
            <div class="hidden xl:flex items-center">
                <div class="flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 dark:border-gray-800 dark:bg-white/[0.03]">
                    <span class="inline-flex h-8 w-8 items-center justify-center rounded-full bg-brand-50 text-brand-600 dark:bg-brand-500/15 dark:text-brand-400">
                        $
                    </span>
                    <div>
                        <p class="text-[11px] font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">Tasa de cambio</p>
                        <p class="text-sm font-semibold text-gray-800 dark:text-white">1 USD = Bs {{ number_format($exchangeRateUsdVes, 2, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                <div class="xl:hidden rounded-md border border-gray-200 bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-700 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-300">
                    1 USD = Bs {{ number_format($exchangeRateUsdVes, 2, ',', '.') }}
                </div>
